                           ...
                           // $query="select from product(product_brand,Product_category,product_title,product_price,product_desc,product_image,product_keywords)";
                            ...
                            $total=mysqli_num_rows($result);
                               ...
                               <tr>
                                      ...
                                      <td>".$rows['product_image']."</td>
                                      <td>".$rows['product_keywords']."</td>
                                   <td><a href = 'del.php?rn=$rows[product_id]' class='btn btn-danger' style='margin-right:10px;'>Delete<a href ='edit.php?rn=$rows[product_id]&pb=$rows[product_brand]&pc=$rows[Product_category]&pt=$rows[product_title] &pp=$rows[product_price]&pd=$rows[product_desc]&pi=$rows[product_image]&pk=$rows[product_keywords]' class='btn btn-primary'>Edit/Update</td>
                                </tr>
                                ";
                                }
                                }
